...
/* Generated By:JavaCC: Do not edit this line. SQLParser.java */
  ...
  final public void parse() throws ParseException, NumberFormatException {Token token;
    label_1:
    while (true) {
...
//}
  final public 
Token primary() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CREATE:{
...
{if ("" != null) return t;}
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x1f00000,0x1f00000,};
	}
