...
public interface SQLVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by the {@code DoCreate}
	 * labeled alternative in {@link SQLParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDoCreate(SQLParser.DoCreateContext ctx);
	/**
	 * Visit a parse tree produced by the {@code DoSelect}
	 * labeled alternative in {@link SQLParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDoSelect(SQLParser.DoSelectContext ctx);
	/**
	 * Visit a parse tree produced by the {@code DoInsert}
	 * labeled alternative in {@link SQLParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDoInsert(SQLParser.DoInsertContext ctx);
	/**
	 * Visit a parse tree produced by the {@code DoUpdate}
	 * labeled alternative in {@link SQLParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDoUpdate(SQLParser.DoUpdateContext ctx);
	/**
	 * Visit a parse tree produced by the {@code DoDelete}
	 * labeled alternative in {@link SQLParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDoDelete(SQLParser.DoDeleteContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code GroupByImpl}
	 * labeled alternative in {@link SQLParser#groupby}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGroupByImpl(SQLParser.GroupByImplContext ctx);
	/**
