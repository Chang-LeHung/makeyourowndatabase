...
public class SQLParser extends Parser {
	...
	public static final int
		...
		SUB=18, AND=19, OR=20, LIKE=21, MINT=22, MFLOAT=23, CREATE=24, SELECT=25, 
		DELETE=26, INSERT=27, UPDATE=28, TABLE=29, WHERE=30, GROUP=31, HAVING=32, 
		BY=33, SET=34, INTO=35, FROM=36, NOT=37, VALUES=38, VALUE=39, NULL=40, 
		UNIQUE=41, FOREIGN=42, REFERENCE=43, TYPE=44, PRIMARY=45, KEY=46, FLOAT=47, 
		INT=48, CHAR=49, VARCHAR=50, STRING=51, BOOL=52, ID=53, WS=54;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'('", "','", "')'", "';'", "'='", "'''", "'\"'", "'!'", "'>'", 
			"'<'", "'>='", "'<='", "'=='", "'!='", "'*'", "'/'", "'+'", "'-'", "'and'", 
			"'or'", "' like'", null, null, "'create'", "'select'", "'delete'", "'insert'", 
			"'update'", "'table'", "'where'", "'group'", "'having'", "'by'", "'set'", 
			"'into'", "'from'", "'not'", "'values'", "'value'", "'null'", "'unique'", 
			"'foreign'", "'references'", null, "'primary'", "'key'", "'float'", "'int'", 
			"'char'", "'varchar'", "'string'", "'bool'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, "MUL", "DIV", "ADD", "SUB", "AND", "OR", "LIKE", "MINT", 
			"MFLOAT", "CREATE", "SELECT", "DELETE", "INSERT", "UPDATE", "TABLE", 
			"WHERE", "GROUP", "HAVING", "BY", "SET", "INTO", "FROM", "NOT", "VALUES", 
			"VALUE", "NULL", "UNIQUE", "FOREIGN", "REFERENCE", "TYPE", "PRIMARY", 
			"KEY", "FLOAT", "INT", "CHAR", "VARCHAR", "STRING", "BOOL", "ID", "WS"
		};
	}
